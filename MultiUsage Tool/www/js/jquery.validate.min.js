...
$.extend($.validator, {
	...
	messages: {
		...
		url: "Insira um URL valido.",
		date: "Insira uma data valida.",
		dateISO: "Insira uma data valida (ISO).",
		number: "Insira um numero valido.",
		digits: "Insira so digitos.",
		creditcard: "Insira um numero de cartao de credito valido.",
		equalTo: "Insira a mesma quantia novamente.",
		maxlength: $.validator.format("Nao insira mais que {0} caracteres."),
		...
		range: $.validator.format("Por valor insira um valor entre {0} e {1}."),
